...
interface ProductoDao {
    ...
    @Query("SELECT * FROM productos WHERE (inventario - vendidos) < :limite ORDER BY (inventario - vendidos) ASC, nombre ASC") fun observarProductosBajoInventario(limite: Int = 5): Flow<List<Producto>>
